...
type NutritionTab = 'food' | 'water' | 'weight' | 'bmr';
...
export default function NutritionModule() {
  ...
  const [activeTab, setActiveTab] = useState<NutritionTab>('food');
    ...
    <CalorieGoalProvider>
      <div>
        ...
        <div style={{ marginTop: 24 }}>
          ...
          <div style={{ border: `1px solid ${theme.border}`, borderRadius: 10, padding: 8, backgroundColor: theme.bgSecondary }}>
