...
function ViewButton({ active, onClick, label, theme, accent, accentGlow }) {
  return (
    <button
      onClick={onClick}
      onMouseEnter={(e) => {
...
export default function CalendarApp() {
  ...
  const addEventTimeParts = useMemo(() => {
  ...
  const updateAddEventTime = ({ hour12, minute, meridiem }) => {
  ...
  const openAddEventMenu = (date, hour = null) => {
  ...
  const applyCalendarCellHighlight = (event) => {
  ...
  const clearCalendarCellHighlight = (event, defaultBorderColor = theme.border, defaultBg = '') => {
    event.currentTarget.style.boxShadow = 'none';
    event.currentTarget.style.borderColor = defaultBorderColor;
