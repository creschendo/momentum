  ...
  useEffect(() => {
    const fetchStats = async ({ background = false } = {}) => {
      ...
      try {
        ...
        const parsedCalorieGoal = savedCalorieGoal ? JSON.parse(savedCalorieGoal) : null;
        const calorieGoalValue = parsedCalorieGoal ? (Number(parsedCalorieGoal.calories ?? parsedCalorieGoal.goalValue) || 2200) : 2200;
