...
router.get('/splits/:id', async (req, res) => {
  try {
    const split = await service.getSplit(req.params.id);
...
router.put('/splits/:id', async (req, res) => {
  try {
    const split = await service.updateSplit(req.params.id, req.body);
    if (!split) return res.status(404).json({ error: 'Split not found' });
    res.json(split);
  } catch (err) {
    res.status(500).json({ error: String(err) });
...
router.delete('/splits/:id', async (req, res) => {
  try {
    const deleted = await service.deleteSplit(req.params.id);
...
router.post('/splits/:splitId/days', async (req, res) => {
  try {
    const day = await service.addDayToSplit(req.params.splitId, req.body);
...
router.put('/splits/:splitId/days/:dayId', async (req, res) => {
  try {
    const day = await service.updateDayInSplit(req.params.splitId, req.params.dayId, req.body);
...
router.delete('/splits/:splitId/days/:dayId', async (req, res) => {
  try {
    const deleted = await service.removeDayFromSplit(req.params.splitId, req.params.dayId);
...
router.post('/splits/:splitId/days/:dayId/lifts', async (req, res) => {
  try {
    const lift = await service.addLiftToDay(req.params.splitId, req.params.dayId, req.body);
...
router.put('/splits/:splitId/days/:dayId/lifts/:liftId', async (req, res) => {
  try {
    const lift = await service.updateLiftInDay(req.params.splitId, req.params.dayId, req.params.liftId, req.body);
...
router.delete('/splits/:splitId/days/:dayId/lifts/:liftId', async (req, res) => {
  try {
    const deleted = await service.removeLiftFromDay(req.params.splitId, req.params.dayId, req.params.liftId);
...
router.post('/splits/:splitId/days/:dayId/cardio', async (req, res) => {
  try {
    const cardio = await service.addCardioToDay(req.params.splitId, req.params.dayId, req.body);
...
router.put('/splits/:splitId/days/:dayId/cardio/:cardioId', async (req, res) => {
  try {
    const cardio = await service.updateCardioInDay(req.params.splitId, req.params.dayId, req.params.cardioId, req.body);
...
router.delete('/splits/:splitId/days/:dayId/cardio/:cardioId', async (req, res) => {
  try {
    const deleted = await service.removeCardioFromDay(req.params.splitId, req.params.dayId, req.params.cardioId);
